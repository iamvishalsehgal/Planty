    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-dvh p-8 text-center bg-cream-300">
          <div className="w-20 h-20 rounded-3xl bg-clay-100 flex items-center justify-center mb-6 shadow-card">
          ...
          <button
            ...
            className="px-6 py-3 bg-sage-600 text-white rounded-2xl font-semibold hover:bg-sage-700 pressable shadow-card"
          >
            Refresh
          </button>
        </div>
